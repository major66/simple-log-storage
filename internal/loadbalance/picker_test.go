...
import (
	...
	"github.com/major66/simple-log-storage/internal/loadbalance"
)
...
type gRPCClientCon struct {
}

func (p *ProducerBuilder) build(gRPCClientCon) balancer.Producer {
	return Producer{}
}
